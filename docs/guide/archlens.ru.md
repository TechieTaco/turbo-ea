...
- **Предлагаемые новые карточки** с переключателями для включения или исключения отдельных карточек и значками редактирования для переименования перед созданием. Этот список включает новые бизнес-возможности, выявленные в ходе оценки.
...
- Каждое новое приложение связывается хотя бы с одной бизнес-возможностью
- Каждая новая бизнес-возможность связывается с выбранными бизнес-целями
...
- **Контекст** из сводки по маппингу возможностей
- **Решение** с выбранным подходом и продуктами
- **Рассмотренные альтернативы** из невыбранных вариантов решений

### Изменение подхода

Нажмите **Choose Different** для выбора другого варианта решения. Оценка пересматривается и пересохраняется с обновлёнными данными, позволяя сравнить подходы перед фиксацией.
