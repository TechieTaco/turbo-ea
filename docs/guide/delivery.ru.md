...
Поставка EA теперь находится в разделе **Отчёты → Поставка EA** (`/reports/ea-delivery`). Унаследованный URL `/ea-delivery` по-прежнему работает как перенаправление, поэтому существующие закладки продолжают резолвиться.

![Управление поставкой EA](../assets/img/ru/17_postavka_ea.png)

## Обзор инициатив

Вкладка «Инициативы» — это **двухпанельное рабочее пространство**:
...
![Записи об архитектурных решениях](../assets/img/ru/17b_postavka_ea_resheniya.png)
...
2. **EA Delivery → вкладка «Инициативы»**: выберите инициативу, нажмите **+ Новый артефакт ▾** в верхней части страницы (или кнопку **+ Добавить** в разделе *Архитектурные решения*) и выберите **Новое архитектурное решение** — инициатива предварительно привязывается как связанная карточка.
