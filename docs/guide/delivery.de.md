...
EA Delivery lebt jetzt unter **Berichte → EA Delivery** (`/reports/ea-delivery`). Die alte URL `/ea-delivery` funktioniert weiterhin als Weiterleitung, sodass bestehende Lesezeichen erhalten bleiben.
